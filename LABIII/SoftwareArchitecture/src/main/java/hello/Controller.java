...
public class Controller {
	...
	public void buscarCarroPorMarca() {
		get("/carro/marca/:marca", (req, res) -> {
			
			List<Carro> carrosEncontradosPorMarca = model.buscarPorMarca(req.params(":marca"));
			
			return new Gson().toJson(carrosEncontradosPorMarca);
		});
	}
